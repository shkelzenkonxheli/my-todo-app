      ...
      <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-2xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-3 mb-6 w-full">
          <input
            ...
            className="flex-1 min-w-0 px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-400"
          />
          <input
            type="date"
            value={deadline}
          ...
          <button
            onClick={handleAdd}
            className="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-lg font-medium flex-shrink-0"
          >
            Add
          </button>
        </div>
